...
const en: Dict = {
  ...
  home: {
    ...
    plans: {
      title: "Free vs VIP",
      subtitle: "See exactly what you get at each tier.",
      freeLabel: "FREE",
      vipLabel: "VIP",
      rows: {
        ...
        monitoring: "Live Trade Monitoring",
        channel: "Access",
      },
      values: {
        teaser: "Teaser only",
  ...
  account: {
    ...
    notificationsNote: "Off by default. When enabled, this device gets a browser notification when a new trade setup is published to the feed. You can turn it off any time.",
    notifyEnabled: "Enable notifications",
    notifyTradeFeed: "New trade setups on the feed",
    notifyMarket: "Market alerts (coming soon)",
    saved: "Saved",
    ...
    pushDenied: "Notifications are blocked in this browser. Allow them in your browser settings for this site, then try again.",
    pushUnsupported: "Browser notifications are not supported here. On iPhone, add Atlas to your Home Screen first, then open it from there.",
    pushError: "Could not turn on notifications. Try again.",
    pushEnableDevice: "Turn on for this device",
    pushTest: "Send a test notification",
    pushTestSent: "Test sent. It should arrive in a moment.",
    pushTestError: "Could not send the test. Try again in a minute.",
  },
};
...
const ar: Dict = {
  ...
  home: {
    ...
    plans: {
      title: "المجاني مقابل VIP",
      subtitle: "شاهد بالضبط ما تحصل عليه في كل مستوى.",
      freeLabel: "مجاني",
      vipLabel: "VIP",
      rows: {
        alerts: "تنبيهات الإشارات",
        entryZone: "منطقة الدخول",
        stopLoss: "وقف الخسارة",
        targets: "أهداف جني الأرباح",
        monitoring: "متابعة حية للصفقة",
        channel: "الوصول",
      },
      values: {
        teaser: "تنبيه مختصر فقط",
        full: "تفاصيل كاملة",
  ...
  account: {
    ...
    notificationsNote: "متوقفة افتراضيًا. عند التفعيل يصلك إشعار في المتصفح على هذا الجهاز عند نشر إعداد صفقة جديد في الخلاصة. يمكنك إيقافها في أي وقت.",
    notifyEnabled: "تفعيل الإشعارات",
    notifyTradeFeed: "إعدادات صفقات جديدة في الخلاصة",
    notifyMarket: "تنبيهات السوق (قريبًا)",
    saved: "تم الحفظ",
    ...
    pushDenied: "الإشعارات محظورة في هذا المتصفح. اسمح بها من إعدادات المتصفح لهذا الموقع ثم حاول مرة أخرى.",
    pushUnsupported: "إشعارات المتصفح غير مدعومة هنا. على آيفون، أضف أطلس إلى الشاشة الرئيسية أولًا ثم افتحه من هناك.",
    pushError: "تعذر تفعيل الإشعارات. حاول مرة أخرى.",
    pushEnableDevice: "فعّل على هذا الجهاز",
    pushTest: "أرسل إشعارًا تجريبيًا",
    pushTestSent: "تم إرسال الإشعار التجريبي. يجب أن يصل خلال لحظات.",
    pushTestError: "تعذر إرسال الإشعار التجريبي. حاول بعد دقيقة.",
  },
};
