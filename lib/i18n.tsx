...
const en: Dict = {
  ...
  home: {
    ...
    features: {
      ...
      deviceBody:
        "Your journal stays in your browser by default. No account required. If you sign in, it syncs to your account so you can use it on other devices.",
    ...
    faq: {
      ...
      a3: "No. Everything works in your browser without an account. Your journal stays on your device unless you sign in, in which case it is also saved to your account so it syncs across your devices.",
  ...
  journal: {
    title: "Journal",
    subtitle: "Saved on this device. Sign in to sync it across your devices. Export anytime.",
  ...
  tradePlan: {
    ...
    savingToAccount: "Saving...",
    savedToAccount: "Saved to your account.",
    accountSaveError: "Could not save to your account. Try again.",
    signInToSave: "Sign in to save plans to your account.",
  ...
  account: {
    title: "Account",
    subtitle: "Your saved trade plans, synced journal and notification preferences.",
    signInPrompt: "Sign in to save trade plans, sync your journal across devices, and manage notifications.",
    signIn: "Sign in",
    signUp: "Create account",
    loading: "Loading...",
    notificationsTitle: "Notifications",
    notificationsNote: "All notifications are off by default. Nothing is sent yet - these are your preferences for when alerts launch.",
    notifyEnabled: "Enable notifications",
    notifyTradeFeed: "New trade setups on the feed",
    notifyMarket: "Market alerts",
    saved: "Saved",
    saveError: "Could not save. Try again.",
    plansTitle: "Saved trade plans",
    plansEmpty: "No saved plans yet.",
    plansLoad: "Open in Trade Plan",
    plansDelete: "Delete",
    plansError: "Could not load your saved plans.",
  },
};
...
const ar: Dict = {
  ...
  home: {
    ...
    features: {
      ...
      deviceBody:
        "يبقى سجل صفقاتك في متصفحك افتراضيًا. لا حاجة لحساب. وإذا سجّلت الدخول فسيُزامَن مع حسابك لتستخدمه على أجهزة أخرى.",
    ...
    faq: {
      ...
      a3: "لا. كل شيء يعمل في متصفحك دون حساب. يبقى سجل صفقاتك على جهازك ما لم تسجّل الدخول، وعندها يُحفظ أيضًا في حسابك ليتزامن بين أجهزتك.",
  ...
  journal: {
    title: "السجل",
    subtitle: "يُحفظ على هذا الجهاز. سجّل الدخول لمزامنته بين أجهزتك. يمكنك التصدير في أي وقت.",
    exportCsv: "تصدير CSV",
  ...
  tradePlan: {
    ...
    savingToAccount: "جارٍ الحفظ...",
    savedToAccount: "تم الحفظ في حسابك.",
    accountSaveError: "تعذر الحفظ في حسابك. حاول مرة أخرى.",
    signInToSave: "سجّل الدخول لحفظ الخطط في حسابك.",
  ...
  account: {
    title: "حسابي",
    subtitle: "خطط صفقاتك المحفوظة وسجلك المتزامن وتفضيلات الإشعارات.",
    signInPrompt: "سجّل الدخول لحفظ خطط الصفقات ومزامنة سجلك بين أجهزتك وإدارة الإشعارات.",
    signIn: "تسجيل الدخول",
    signUp: "إنشاء حساب",
    loading: "جارٍ التحميل...",
    notificationsTitle: "الإشعارات",
    notificationsNote: "كل الإشعارات متوقفة افتراضيًا. لا يُرسل شيء حاليًا — هذه تفضيلاتك لحين إطلاق التنبيهات.",
    notifyEnabled: "تفعيل الإشعارات",
    notifyTradeFeed: "إعدادات صفقات جديدة في الخلاصة",
    notifyMarket: "تنبيهات السوق",
    saved: "تم الحفظ",
    saveError: "تعذر الحفظ. حاول مرة أخرى.",
    plansTitle: "خطط الصفقات المحفوظة",
    plansEmpty: "لا توجد خطط محفوظة بعد.",
    plansLoad: "افتح في خطة الصفقة",
    plansDelete: "حذف",
    plansError: "تعذر تحميل خططك المحفوظة.",
  },
};
